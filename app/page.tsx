    ...
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-center bg-white overflow-hidden">
        ...
        <div className="relative z-10 width-limit pt-20 pb-16">
          ...
          {/* Main headline — big, bold, serif */}
          <h1 className="reveal delay-2 font-display mb-6" style={{
          ...
          <p className="reveal delay-3 text-lg text-slate-500 mb-12 leading-relaxed max-w-xl font-light">
          ...
          <div className="reveal delay-4 flex flex-wrap gap-4 mb-20">
            <Link
              href="/guidelines"
              className="group relative overflow-hidden bg-gray-950 text-white px-8 py-4 rounded-full font-semibold text-base transition-all duration-300 hover:shadow-2xl hover:shadow-gray-950/20 hover:-translate-y-0.5"
            >
          ...
          {/* Stats row */}
          <div className="reveal delay-5 grid grid-cols-2 sm:grid-cols-4 gap-6 pt-8 border-t border-gray-100">
            {[
              { stat: "10+", label: "AI-verktøy vurdert" },
              { stat: "6", label: "Viktige emner" },
              { stat: "100%", label: "Gratis" },
              { stat: "3", label: "Brukerroller" },
            ].map((item, i) => (
              <div key={i}>
                <div className="font-display text-3xl font-light text-gray-950 mb-1"
      ...
      <section className="py-28 bg-gray-950 text-white relative overflow-hidden">
        ...
        />
        <div
          className="mesh-blob w-[600px] h-[600px]"
            ...
            {[
              {
                num: "01",
                title: "For Studenter",
                description: "Sjekklister, eksempler og klare regler for hva du kan og ikke kan bruke AI til.",
                href: "/about/student",
                accent: "#3b82f6",
              },
              {
                num: "02",
                title: "For Lærere",
                description: "Ferdige oppgavemaler, diskusjonsspørsmål og forklaringer du kan bruke i undervisningen.",
                href: "/about/teacher",
                accent: "#10b981",
              },
              {
                ...
                description: "Implementeringsrammeverk og policymaler for konsistente AI-retningslinjer.",
              ...
              >
                ...
                <div className="relative z-10">
                  <div
                    className="w-1 h-12 rounded-full mb-6 transition-all duration-300 group-hover:h-16"
          ...
          <div className="grid md:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-gray-100">
            {[
              ...
              },
              {
                ...
                description: "Få klare regler for personvern, kildekritikk og digital etikk for hver oppgave.",
                link: "/guidelines",
              },
              {
                step: "03",
                title: "Vis at du kan det",
                description: "Fullfør quizen og dokumenter at du jobber ansvarlig.",
                link: "/quiz",
              },
            ].map((item, idx) => (
              <Link
              ...
              >
                <div
                  className="font-display text-8xl font-light mb-6 leading-none transition-all duration-300"
                  style={{
                    fontFamily: "'DM Serif Display', Georgia, serif",
      ...
      <section className="py-12 bg-white">
        <div className="width-limit">
          <div className="relative rounded-3xl overflow-hidden reveal" style={{ background: "linear-gradient(135deg, #0a0a0a 0%, #0f172a 50%, #0a0a0a 100%)" }}>
            {/* Grid on dark CTA */}
            <div
              className="absolute inset-0 pointer-events-none"
              style={{
            ...
            <div className="relative z-10 px-12 py-20 text-center">
              ...
              <p className="text-gray-400 font-light max-w-lg mx-auto mb-12 leading-relaxed">
