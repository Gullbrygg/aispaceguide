  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        ...
        "Spørsmål om begreper du ikke forstår",
      ],
      correct: 1,
    },
    {
    ...
    {
      question: "Hva er det viktigste å gjøre FØR du bruker AI til en oppgave?",
      options: [
        "Sjekke personvernpolicyen til AI-verktøyet",
        "Kjøpe premium-versjonen",
        "Lese oppgavebeskrivelsen og retningslinjene fra læreren",
        "Dele oppgaven med en klassekamerat",
      ],
      correct: 2,
    },
    {
      question: "Hvordan burde du håndtere AI-generert innhold i oppgaven din?",
      options: [
        "Presentere det som ditt eget arbeid",
        "Parafrasere det og integrere det med ditt eget arbeid og kildekritikk",
        "Kopiere det og sitere ChatGPT som eneste forfatter",
        "Ikke bruke AI i det hele tatt",
      ],
      correct: 1,
    },
    {
      question: "Hva betyr det at AI-modeller trenes på menneskeprodusert data?",
      options: [
        "AI er alltid like smart som mennesker",
        "Mennesker må kontrollere AI én gang i timen",
        "AI kan arve bias og fordommer fra treningsdataene",
        "AI og mennesker er identiske i evner",
      ],
      correct: 2,
    },
    {
      question: "Hvilken av disse er en god grunn til å bruke AI i studiene?",
      options: [
        "Unngå å gjøre ditt eget arbeid",
        "Lure læreren til å tro du kan mer enn du kan",
        "Garantert få bedre karakterer",
        "Få inspirasjon og forklaringer som utgangspunkt for videre tenkning",
      ],
      correct: 3,
    },
    {
      ...
      options: [
        "Bruke AI likevel fordi det sannsynligvis er greit",
        "Håpe på det beste",
        "Spørre læreren din direkte",
        "La være å levere oppgaven",
      ],
      correct: 2,
    },
  ];
