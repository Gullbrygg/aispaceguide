...
const onConnect = spacetimedb.clientConnected((ctx) => {
	...
	console.log(jwt);
	if (jwt.issuer !== "https://active-mouse-40.clerk.accounts.dev") throw new SenderError(`Unauthorized: unexpected issuer ${jwt.issuer}`);
	if (!ctx.db.user.id.find(ctx.sender)) ctx.db.user.insert({
		id: ctx.sender,
		clerkId: jwt.subject,
		name: void 0,
